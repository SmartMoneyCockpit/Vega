#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""Color Guard Europe using 50DMA + VIX with fallback"""
...
payload = {"region": "EU", "generated_at_utc": dt.datetime.utcnow().isoformat(timespec="seconds")+"Z"}
ok, data = compute_color(["VGK","EZU","EWU","FEZ"])
payload.update(data)
