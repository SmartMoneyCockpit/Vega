#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""Color Guard APAC using 50DMA + VIX with fallback"""
...
payload = {"region": "APAC", "generated_at_utc": dt.datetime.utcnow().isoformat(timespec="seconds")+"Z"}
ok, data = compute_color(["EWJ","EWA","EWH","EWY"])
payload.update(data)
out = pathlib.Path("alerts")/"color_guard_apac.json"
out.parent.mkdir(parents=True, exist_ok=True)
out.write_text(json.dumps(payload, indent=2), encoding="utf-8")
print(f"[color_guard_apac] wrote {out}")
