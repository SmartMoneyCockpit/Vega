...
IB_PORT = int(os.getenv("IB_PORT", "7496"))  # default LIVE=7496 (override to 7497 for paper)
IB_CLIENT_ID = int(os.getenv("IB_CLIENT_ID", "9"))
IB_PAPER_ONLY = os.getenv("IB_PAPER_ONLY", "false").lower() == "true"  # default false for live
