...
st.set_page_config(page_title="APAC — Text Dashboard v1.2", layout="wide")
st.title("APAC — Text Dashboard v1.2")
...
def tv_chart_html(symbol: str, interval: str="D", theme: str="light", height: int=460) -> str:
    cfg = {
        ...
        "autosize": True, "container_id": "tv_apac_chart"
    }
    return f"""
<div id="tv_apac_chart" style="height:{height}px;"></div>
...
symbol = c1.selectbox("Symbol", APAC_LIST, index=0)
