...
st.set_page_config(page_title="North America — Text Dashboard v1.1", layout="wide")
st.title("North America — Text Dashboard v1.1")
...
if os.path.isfile(CAL_CSV):
    ...
    st.download_button("Download filtered .ics", to_ics(dfv), file_name="econ_calendar_na_filtered.ics",
                       mime="text/calendar")
else:
