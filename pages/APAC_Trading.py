...
if not cfg_path.exists():
    st.error("Missing config: config/markets/apac.yaml")
    st.stop()
st.success("APAC config loaded.")
...
st.caption(
    "Upgrade path: wire to your data layer for live prices, breadth, options IV, and earnings windows."
)
